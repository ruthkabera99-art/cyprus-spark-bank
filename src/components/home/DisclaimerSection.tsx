        ...
        <div className="flex gap-3 items-start max-w-4xl mx-auto">
          ...
          <div className="space-y-2">
            <p className="text-xs text-muted-foreground leading-relaxed">
              <strong>Important Disclosures:</strong> MorganFinance Bank is an FDIC-insured institution. Deposits are insured up to $250,000 per depositor, per insured bank, for each account ownership category. Loan products are subject to credit approval. Rates, terms, and conditions are subject to change without notice.
            </p>
            <p className="text-xs text-muted-foreground leading-relaxed">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed">
              Equal Housing Lender. NMLS# 123456. © {new Date().getFullYear()} MorganFinance Bank. All rights reserved.
            </p>
          </div>
        </div>
      </div>
